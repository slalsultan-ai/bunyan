...
export const metadata: Metadata = {
  ...
  description: 'منصة تدريب تفاعلية تجهّز طفلك لاختبار القدرات العامة من عمر 4 سنوات — بأسلوب ممتع يحبه الأطفال',
  keywords: ['اختبار القدرات', 'GAT', 'تعليم أطفال', 'تدريب', 'قياس', 'Saudi education'],
  openGraph: {
    title: 'بُنيان — منصة تدريب اختبار القدرات للأطفال',
    description: 'ابنِ قدرات طفلك من اليوم — تدريب تفاعلي من عمر 4 سنوات',
    locale: 'ar_SA',
    type: 'website',
  },
};
